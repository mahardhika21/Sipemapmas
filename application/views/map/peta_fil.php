  ...
  <tr>
    ...
    <td>100%</td>
          ...
          <div class="modal-footer">
			...
			<a href="<?php echo site_url('home/pdf_prov2/'.$th .'/'.$fak.'/'.$prod) ?>" class="btn btn-primary"  title="Print Laporan Berdasarkan Provinsi" ><i class="fa fa-print" aria-hidden="true"></i> Print Berdasarkan Provinsi<a>
			<a href="<?php echo site_url('home/pdf_asal2/'.$th .'/'.$fak.'/'.$prod) ?>" class="btn btn-primary"  title="Print Laporan Berdasarkan Asal Sekolah"><i class="fa fa-print" aria-hidden="true"></i> Print berdasarkan Asal Sekolah<a>
          </div>
...
<div class="navbar navbar-default navbar-fixed-bottom footer-bottom">
   <div class="container text-center">
	  ...
	  <a class="" href="" data-toggle="modal" data-target="#imgModal">data tabel Provinsi</a> ||
	  	  <a class="" href="" data-toggle="modal" data-target="#grafModal">data tabel Kabupaten</a>
