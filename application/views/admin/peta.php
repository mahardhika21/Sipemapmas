...
var jogja=<?php echo $jogja; ?>;  
    ...
    $('#container').highcharts('Map', {
        ...
        title : {
            text : 'Jumlah Mahasiswa Universitas Respati Yogyakarta pada Tahun <?php echo $th; ?>'
        },

        subtitle : {
            text : '(Sumber : Biro Humas dan Promosi)'
        },
        ...
        series : [{
            ...
            joinBy: 'hc-key',
            name: 'Jumlah Mahsiswa Berasal dari',
            states: {
                hover: {
                    color: '#BADA55'
                }
...
<div class="modal fade" id="imgModal" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <tr>
    ...
    <td><?php echo $lampung; ?></td>
    <td><?php echo round($lampung*100/$total) ." %"; ?></td>
  </tr>
  ...
  <tr>
    ...
    <td>100%</td>
          ...
          <div class="modal-footer">
			...
			<a href="<?php echo site_url('home/pdf_prov/'.$th .'') ?>" class="btn btn-primary"  title="Print Laporan Berdasar Provinsi" ><i class="fa fa-print" aria-hidden="true"></i> Print 1<a>
			<a href="<?php echo site_url('home/pdf_asal/'.$th .'') ?>" class="btn btn-primary"  title="Print Laporan Berdasar Asal Sekolah"><i class="fa fa-print" aria-hidden="true"></i> Print 2<a>
          </div>
...
<div class="modal fade" id="grafModal" tabindex="1" role="dialog" aria-labelledby="myModalLabe2">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-window-close-o" aria-hidden="true"></i></button>
            <h4 class="modal-title">Data Persebaran Berdasar Kabupaten</h4>
          </div>
          <div class="modal-body">
		 <iframe src="<?php echo site_url('Home/data_kab/'. $th.'/0/'. $total.''); ?>" style="overflow: scroll;" width="870" height="500">
This is an iframe.
</iframe>
		  </div>
          <div class="modal-footer">
